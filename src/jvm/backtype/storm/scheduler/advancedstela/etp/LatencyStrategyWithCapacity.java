...
public class LatencyStrategyWithCapacity {
    ...
    public ArrayList<ResultComponent> topologyCapacityAscending()
    {
        HashMap<String, Component> components = topologySchedule.getComponents();
        List<Component> comp  = new ArrayList<Component>(components.values());
        Collections.sort(comp, Collections.reverseOrder());
	...
	private void congestionDetection() {
        HashMap<String, Component> components = topologySchedule.getComponents();
        for (Entry<String, Double> componentRate : expectedExecutedRates.entrySet()) {
    ...
    private void collectRates() {
        for (Entry<String, List<Integer>> emitThroughput : topologyStatistics.getEmitThroughputHistory().entrySet()) {
        ...
        for (Entry<String, Component> component : topologySchedule.getComponents().entrySet()) {
